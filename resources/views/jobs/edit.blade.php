    ...
    <form method="POST" action="/jobs/{{ $job->id }}">
                        ...
                        <div class="mt-2">
                            <div
                                ...
                                <input type="text" name="salary" id="salary"
                                    class="block min-w-0 grow py-1.5 pr-3 px-3 text-base text-gray-900 placeholder:text-gray-400 focus:outline-none sm:text-sm/6"
                                    placeholder="$40,000 Per Year" value="{{ $job->salary }}" required>
                            </div>
        ...
        <div class="mt-6 flex items-center justify-between gap-x-6">
            <div>
                <button 
                    form="delete-form"
                    class="bg-red-600 hover:bg-red-700 text-white font-semibold py-2 px-4 rounded shadow-sm focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2">
                    Delete
                </button>
            </div>
